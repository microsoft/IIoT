...
- a Sense Hat Emulator installed on the Raspberry Pi.
...
## Requirements
- Raspberry Pi 3 (Pi Model 2 will probably work as well) with latest version of Raspian installed on the micro SD card. Using NOOBS works fine. 
